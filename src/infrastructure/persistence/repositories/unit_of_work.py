...
from src.infrastructure.persistence.repositories.fortune_management.fortune_repository import FortuneRepository
...
class UnitOfWork(BaseDomainUnitOfWork):
    ...
    def fortunes(self) -> fortune_repository.FortuneRepository:
        return self.__get_repository(FortuneRepository)(self.session, not self._depth)
